...
cmd = f"nice -n 19 ~frey/bin/osemmw mwosem.2ws.par {prj_nf} {atn} {out_prefix}.nf.recon >& {out_prefix}.nf.recon.log"
runcmd(cmd,cpu_count(), 60)

# Reconstruct noisey projections
cmd = f"nice -n 19 ~frey/bin/osemmw mwosem.2ws.par {prj_n} {atn} {out_prefix}.n.recon >& {out_prefix}.n.recon.log"
runcmd(cmd,cpu_count(), 60)
waitall()
print("Done")